...
public class DataMaskingPatternLayout extends HTMLLayout
{
    ...
    public void addMaskPattern(String maskPattern) {
        ...
        System.out.println(maskPatterns.stream()
                .collect(Collectors.joining("|")));
        aplpliedPattern = Pattern.compile( maskPatterns.stream()
                .collect(Collectors.joining("|")), Pattern.MULTILINE|Pattern.CASE_INSENSITIVE);
    }
